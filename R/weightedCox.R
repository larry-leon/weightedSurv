...
#'
#' Fits a weighted Cox model using rho-gamma weights and returns estimates and statistics.
#'
#' @param dfcount Data frame with counting process data.
#' @param scheme Character string specifying the weighting scheme (default: "fh").
#' @param scheme_params List of parameters for the scheme (default: list(rho = 0, gamma = 0.5)).
#' @param draws Number of resampling draws (default: 0).
#' @param alpha Significance level (default: 0.05).
